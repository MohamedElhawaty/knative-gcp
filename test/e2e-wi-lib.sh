...
function test_setup() {
  ...
  wi_controllers_gsa_setup || return 1
  wi_sources_gsa_setup || return 1
...
function wi_controllers_gsa_setup() {
...
function wi_broker_gsa_setup() {
  echo "Broker Service Account Setup"
